...
###
permute.comm <- function(mat1, mat2)
# Function to permute community composition data, species by species independently.
# However, the species are permuted in the same way in mat1 and mat2.
...
# 			t.res <- t.paired.perm(tmp$vecB,tmp$vecC,nperm=nperm1,alternative="two.sided")
